...
for num in test_valores: # En la lista se puso ¨valores¨ en español y despues se cambio a ¨values¨ en inglés lo cual marcaba un error en la variable y provocaba un NameError.
